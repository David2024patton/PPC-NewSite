    ...
    >
      ...
      >
        ...
        <p className="text-xs text-gray-500 mb-4">
          After 2 months, your price returns to $95.94/mo.
        </p>
        ...
        <div className="flex gap-4 mb-6">
          <Button
            onClick={() =>
              handleRedirect(
                "https://link.fastpaydirect.com/payment-link/687f881beba110a1b08dc7bc?couponCode=GOLDFT",
              )
            }
          ...
          <Button
            onClick={() =>
              handleRedirect("https://link.fastpaydirect.com/payment-link/687f881beba110a1b08dc7bc")
            }
            variant="outline"
        ...
        <div className="border-t pt-4">
          <h3 className="font-bold text-gray-800 text-lg">🏆 ULTIMATE UPGRADE AVAILABLE! 🏆</h3>
          <p className="text-sm text-gray-600 my-2">
            Get our PLATINUM plan with everything included!
          </p>
          ...
          >
            ...
            Upgrade to PLATINUM - Best Value!
...
export default GoldUpsellModal;
